...
SERVICE_TOKEN_FILENAME = pathlib.Path("/var/run/secrets/kubernetes.io/serviceaccount/token")
SERVICE_CERT_FILENAME = pathlib.Path("/var/run/secrets/kubernetes.io/serviceaccount/ca.crt")
