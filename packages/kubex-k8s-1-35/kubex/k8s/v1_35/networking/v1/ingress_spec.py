...
from kubex.k8s.v1_35.networking.v1.ingress_backend import IngressBackend
from kubex.k8s.v1_35.networking.v1.ingress_rule import IngressRule
from kubex.k8s.v1_35.networking.v1.ingress_tls import IngressTLS
