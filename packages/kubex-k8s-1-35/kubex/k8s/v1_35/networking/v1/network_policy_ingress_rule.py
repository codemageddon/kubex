from kubex.k8s.v1_35.networking.v1.network_policy_peer import NetworkPolicyPeer
from kubex.k8s.v1_35.networking.v1.network_policy_port import NetworkPolicyPort
