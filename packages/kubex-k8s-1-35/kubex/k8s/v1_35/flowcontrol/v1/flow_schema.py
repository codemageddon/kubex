...
from kubex.k8s.v1_35.flowcontrol.v1.flow_schema_spec import FlowSchemaSpec
from kubex.k8s.v1_35.flowcontrol.v1.flow_schema_status import FlowSchemaStatus
