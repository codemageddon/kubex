from kubex.k8s.v1_35.resource.v1beta2.capacity_requirements import CapacityRequirements
from kubex.k8s.v1_35.resource.v1beta2.device_selector import DeviceSelector
from kubex.k8s.v1_35.resource.v1beta2.device_toleration import DeviceToleration
