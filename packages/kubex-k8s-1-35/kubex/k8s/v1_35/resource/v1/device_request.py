from kubex.k8s.v1_35.resource.v1.device_sub_request import DeviceSubRequest
from kubex.k8s.v1_35.resource.v1.exact_device_request import ExactDeviceRequest
