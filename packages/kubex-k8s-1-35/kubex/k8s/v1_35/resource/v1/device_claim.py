from kubex.k8s.v1_35.resource.v1.device_claim_configuration import (
    DeviceClaimConfiguration,
)
from kubex.k8s.v1_35.resource.v1.device_constraint import DeviceConstraint
from kubex.k8s.v1_35.resource.v1.device_request import DeviceRequest
