from kubex.k8s.v1_35.admissionregistration.v1beta1.apply_configuration import (
    ApplyConfiguration,
)
from kubex.k8s.v1_35.admissionregistration.v1beta1.json_patch import JSONPatch
