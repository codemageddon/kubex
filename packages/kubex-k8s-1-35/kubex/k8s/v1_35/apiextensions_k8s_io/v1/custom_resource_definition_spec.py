from kubex.k8s.v1_35.apiextensions_k8s_io.v1.custom_resource_conversion import (
    CustomResourceConversion,
)
from kubex.k8s.v1_35.apiextensions_k8s_io.v1.custom_resource_definition_names import (
    CustomResourceDefinitionNames,
)
from kubex.k8s.v1_35.apiextensions_k8s_io.v1.custom_resource_definition_version import (
