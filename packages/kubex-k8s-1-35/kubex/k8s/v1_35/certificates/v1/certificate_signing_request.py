...
from kubex.k8s.v1_35.certificates.v1.certificate_signing_request_spec import (
    CertificateSigningRequestSpec,
)
from kubex.k8s.v1_35.certificates.v1.certificate_signing_request_status import (
