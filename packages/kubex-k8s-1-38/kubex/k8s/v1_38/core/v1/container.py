...
from kubex.k8s.v1_38.core.v1.container_port import ContainerPort
from kubex.k8s.v1_38.core.v1.container_resize_policy import ContainerResizePolicy
from kubex.k8s.v1_38.core.v1.container_restart_rule import ContainerRestartRule
from kubex.k8s.v1_38.core.v1.env_from_source import EnvFromSource
from kubex.k8s.v1_38.core.v1.env_var import EnvVar
from kubex.k8s.v1_38.core.v1.lifecycle import Lifecycle
from kubex.k8s.v1_38.core.v1.probe import Probe
from kubex.k8s.v1_38.core.v1.resource_requirements import ResourceRequirements
from kubex.k8s.v1_38.core.v1.security_context import SecurityContext
from kubex.k8s.v1_38.core.v1.volume_device import VolumeDevice
from kubex.k8s.v1_38.core.v1.volume_mount import VolumeMount
...
class Container(BaseK8sModel):
    ...
    restart_policy_rules: list[ContainerRestartRule] | None = Field(
        default=None,
