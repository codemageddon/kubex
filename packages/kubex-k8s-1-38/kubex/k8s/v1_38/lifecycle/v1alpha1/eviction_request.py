...
from kubex.k8s.v1_38.lifecycle.v1alpha1.eviction_request_spec import EvictionRequestSpec
from kubex.k8s.v1_38.lifecycle.v1alpha1.eviction_request_status import (
