...
class ResponderStatus(BaseK8sModel):
    ...
    expected_completion_time: datetime.datetime | None = Field(
        default=None,
        alias="expectedCompletionTime",
    ...
    heartbeat_time: datetime.datetime | None = Field(
        default=None,
        alias="heartbeatTime",
    ...
    name: str = Field(
        ...,
        alias="name",
        description='name allows you to identify the responder reacting to the Eviction. It must be a valid domain-prefixed key (such as "acme.io/foo"). This field is initialized by Kubernetes and must be unique for each responder. This field is required.',
    )
