...
from kubex.k8s.v1_38.resource.v1alpha3.device_taint import DeviceTaint
from kubex.k8s.v1_38.resource.v1alpha3.device_taint_selector import DeviceTaintSelector
