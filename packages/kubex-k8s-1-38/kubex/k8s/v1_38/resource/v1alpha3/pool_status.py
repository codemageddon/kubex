...
from kubex.k8s.v1_38.resource.v1alpha3.partition_type_status import PartitionTypeStatus
from kubex.k8s.v1_38.resource.v1alpha3.shareable_summary_status import (
