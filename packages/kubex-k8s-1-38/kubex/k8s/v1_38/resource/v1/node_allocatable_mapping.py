...
class NodeAllocatableMapping(BaseK8sModel):
    ...
    capacity_multiplier: str | None = Field(
        default=None,
        alias="capacityMultiplier",
    ...
    device_multiplier: str | None = Field(
        default=None,
        alias="deviceMultiplier",
