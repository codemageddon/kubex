...
from kubex.k8s.v1_38.resource.v1.node_allocatable_mapping import NodeAllocatableMapping
from kubex.k8s.v1_38.resource.v1.node_allocatable_overhead import (
