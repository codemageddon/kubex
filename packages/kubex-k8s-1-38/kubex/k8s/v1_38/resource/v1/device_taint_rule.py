...
from kubex.k8s.v1_38.resource.v1.device_taint_rule_spec import DeviceTaintRuleSpec
from kubex.k8s.v1_38.resource.v1.device_taint_rule_status import DeviceTaintRuleStatus
