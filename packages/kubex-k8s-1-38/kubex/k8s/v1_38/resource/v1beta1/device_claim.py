...
from kubex.k8s.v1_38.resource.v1beta1.device_claim_configuration import (
    DeviceClaimConfiguration,
)
from kubex.k8s.v1_38.resource.v1beta1.device_constraint import DeviceConstraint
from kubex.k8s.v1_38.resource.v1beta1.device_request import DeviceRequest
