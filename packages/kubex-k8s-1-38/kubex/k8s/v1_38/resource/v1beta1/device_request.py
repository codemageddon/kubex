...
from kubex.k8s.v1_38.resource.v1beta1.capacity_requirements import CapacityRequirements
from kubex.k8s.v1_38.resource.v1beta1.device_derived_attribute import (
    DeviceDerivedAttribute,
)
from kubex.k8s.v1_38.resource.v1beta1.device_selector import DeviceSelector
from kubex.k8s.v1_38.resource.v1beta1.device_sub_request import DeviceSubRequest
...
class DeviceRequest(BaseK8sModel):
    ...
    capacity: CapacityRequirements | None = Field(
        default=None,
        alias="capacity",
