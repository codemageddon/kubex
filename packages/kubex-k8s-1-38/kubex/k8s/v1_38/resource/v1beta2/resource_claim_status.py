...
from kubex.k8s.v1_38.resource.v1beta2.allocated_device_status import (
    AllocatedDeviceStatus,
)
from kubex.k8s.v1_38.resource.v1beta2.allocation_result import AllocationResult
from kubex.k8s.v1_38.resource.v1beta2.resource_claim_consumer_reference import (
