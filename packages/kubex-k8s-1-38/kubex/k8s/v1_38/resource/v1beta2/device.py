...
from kubex.k8s.v1_38.resource.v1beta2.device_attribute import DeviceAttribute
from kubex.k8s.v1_38.resource.v1beta2.device_capacity import DeviceCapacity
from kubex.k8s.v1_38.resource.v1beta2.device_counter_consumption import (
    DeviceCounterConsumption,
)
from kubex.k8s.v1_38.resource.v1beta2.device_taint import DeviceTaint
from kubex.k8s.v1_38.resource.v1beta2.node_allocatable_resource import (
...
class Device(BaseK8sModel):
    ...
    node_allocatable_resources: dict[str, NodeAllocatableResource] | None = Field(
        default=None,
        alias="nodeAllocatableResources",
