...
from kubex.k8s.v1_38.storagemigration.v1.storage_version_migration_spec import (
    StorageVersionMigrationSpec,
)
from kubex.k8s.v1_38.storagemigration.v1.storage_version_migration_status import (
...
class StorageVersionMigration(ClusterScopedEntity, HasStatusSubresource):
    ...
    api_version: Literal["storagemigration.k8s.io/v1"] = Field(
        default="storagemigration.k8s.io/v1",
        alias="apiVersion",
