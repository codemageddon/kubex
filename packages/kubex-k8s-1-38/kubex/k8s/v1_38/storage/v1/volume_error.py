...
class VolumeError(BaseK8sModel):
    ...
    error_code: int | None = Field(
        default=None,
        alias="errorCode",
        description="errorCode is a numeric gRPC code representing the error encountered during Attach or Detach operations. This field requires the MutableCSINodeAllocatableCount feature gate being enabled to be set.",
    )
