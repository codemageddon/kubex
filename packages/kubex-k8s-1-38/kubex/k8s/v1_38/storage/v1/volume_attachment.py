...
from kubex.k8s.v1_38.storage.v1.volume_attachment_spec import VolumeAttachmentSpec
from kubex.k8s.v1_38.storage.v1.volume_attachment_status import VolumeAttachmentStatus
