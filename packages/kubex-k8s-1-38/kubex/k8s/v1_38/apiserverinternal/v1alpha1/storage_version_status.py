...
from kubex.k8s.v1_38.apiserverinternal.v1alpha1.server_storage_version import (
    ServerStorageVersion,
)
from kubex.k8s.v1_38.apiserverinternal.v1alpha1.storage_version_condition import (
