...
from kubex.k8s.v1_38.apiserverinternal.v1alpha1.storage_version_spec import (
    StorageVersionSpec,
)
from kubex.k8s.v1_38.apiserverinternal.v1alpha1.storage_version_status import (
