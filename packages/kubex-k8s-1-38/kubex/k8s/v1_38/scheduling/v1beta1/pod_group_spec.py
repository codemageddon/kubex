...
from kubex.k8s.v1_38.scheduling.v1beta1.disruption_mode import DisruptionMode
from kubex.k8s.v1_38.scheduling.v1beta1.pod_group_resource_claim import (
    PodGroupResourceClaim,
)
from kubex.k8s.v1_38.scheduling.v1beta1.pod_group_scheduling_constraints import (
    PodGroupSchedulingConstraints,
)
from kubex.k8s.v1_38.scheduling.v1beta1.pod_group_scheduling_policy import (
    PodGroupSchedulingPolicy,
)
from kubex.k8s.v1_38.scheduling.v1beta1.workload_reference import WorkloadReference
