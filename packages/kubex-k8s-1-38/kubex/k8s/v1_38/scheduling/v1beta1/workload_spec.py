...
from kubex.k8s.v1_38.scheduling.v1beta1.composite_pod_group_template import (
    CompositePodGroupTemplate,
)
from kubex.k8s.v1_38.scheduling.v1beta1.pod_group_template import PodGroupTemplate
from kubex.k8s.v1_38.scheduling.v1beta1.typed_local_object_reference import (
