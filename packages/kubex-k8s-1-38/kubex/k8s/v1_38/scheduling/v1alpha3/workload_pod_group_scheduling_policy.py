...
from kubex.k8s.v1_38.scheduling.v1alpha3.workload_pod_group_basic_scheduling_policy import (
    WorkloadPodGroupBasicSchedulingPolicy,
)
from kubex.k8s.v1_38.scheduling.v1alpha3.workload_pod_group_gang_scheduling_policy import (
