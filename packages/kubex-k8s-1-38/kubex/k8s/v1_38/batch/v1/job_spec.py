...
from kubex.k8s.v1_38.batch.v1.job_scheduling_configuration import (
    JobSchedulingConfiguration,
)
from kubex.k8s.v1_38.batch.v1.pod_failure_policy import PodFailurePolicy
from kubex.k8s.v1_38.batch.v1.success_policy import SuccessPolicy
from kubex.k8s.v1_38.core.v1.pod_template_spec import PodTemplateSpec
from kubex.k8s.v1_38.meta.v1.label_selector import LabelSelector
from kubex_core.models.base import BaseK8sModel


class JobSpec(BaseK8sModel):
    ...
    pod_failure_policy: PodFailurePolicy | None = Field(
        default=None,
    ...
    success_policy: SuccessPolicy | None = Field(
        default=None,
        alias="successPolicy",
