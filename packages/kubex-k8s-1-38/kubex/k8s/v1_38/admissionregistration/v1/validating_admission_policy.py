...
from kubex.k8s.v1_38.admissionregistration.v1.validating_admission_policy_spec import (
    ValidatingAdmissionPolicySpec,
)
from kubex.k8s.v1_38.admissionregistration.v1.validating_admission_policy_status import (
