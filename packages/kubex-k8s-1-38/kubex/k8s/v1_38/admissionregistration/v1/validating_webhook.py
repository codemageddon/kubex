...
from kubex.k8s.v1_38.admissionregistration.v1.rule_with_operations import (
    RuleWithOperations,
)
from kubex.k8s.v1_38.admissionregistration.v1.webhook_client_config import (
    WebhookClientConfig,
)
...
class ValidatingWebhook(BaseK8sModel):
    ...
    rules: list[RuleWithOperations] | None = Field(
        default=None,
        alias="rules",
