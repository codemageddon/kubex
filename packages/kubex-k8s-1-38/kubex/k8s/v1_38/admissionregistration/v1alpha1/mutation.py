...
from kubex.k8s.v1_38.admissionregistration.v1alpha1.apply_configuration import (
    ApplyConfiguration,
)
from kubex.k8s.v1_38.admissionregistration.v1alpha1.json_patch import JSONPatch
