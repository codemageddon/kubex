...
from kubex.k8s.v1_38.authorization.v1.non_resource_attributes import (
    NonResourceAttributes,
)
from kubex.k8s.v1_38.authorization.v1.resource_attributes import ResourceAttributes
