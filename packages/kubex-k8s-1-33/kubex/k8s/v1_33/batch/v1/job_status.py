...
from kubex.k8s.v1_33.batch.v1.job_condition import JobCondition
from kubex.k8s.v1_33.batch.v1.uncounted_terminated_pods import UncountedTerminatedPods
...
class JobStatus(BaseK8sModel):
    ...
    conditions: list[JobCondition] | None = Field(
        default=None,
        alias="conditions",
