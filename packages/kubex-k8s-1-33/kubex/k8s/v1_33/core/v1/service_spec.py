...
from kubex.k8s.v1_33.core.v1.service_port import ServicePort
from kubex.k8s.v1_33.core.v1.session_affinity_config import SessionAffinityConfig
...
class ServiceSpec(BaseK8sModel):
    ...
    cluster_ips: list[str] | None = Field(
        default=None,
        alias="clusterIPs",
