...
from kubex.k8s.v1_33.networking.v1.network_policy_egress_rule import (
    NetworkPolicyEgressRule,
)
from kubex.k8s.v1_33.networking.v1.network_policy_ingress_rule import (
...
class NetworkPolicySpec(BaseK8sModel):
    ...
    pod_selector: LabelSelector = Field(
        ...,
        alias="podSelector",
