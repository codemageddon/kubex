...
from kubex.k8s.v1_33.certificates.v1.certificate_signing_request_spec import (
    CertificateSigningRequestSpec,
)
from kubex.k8s.v1_33.certificates.v1.certificate_signing_request_status import (
