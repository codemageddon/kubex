...
from kubex.k8s.v1_33.apiextensions_k8s_io.v1.custom_resource_definition_condition import (
    CustomResourceDefinitionCondition,
)
from kubex.k8s.v1_33.apiextensions_k8s_io.v1.custom_resource_definition_names import (
