...
from kubex.k8s.v1_33.admissionregistration.v1beta1.audit_annotation import (
    AuditAnnotation,
)
from kubex.k8s.v1_33.admissionregistration.v1beta1.match_condition import MatchCondition
from kubex.k8s.v1_33.admissionregistration.v1beta1.match_resources import MatchResources
from kubex.k8s.v1_33.admissionregistration.v1beta1.param_kind import ParamKind
from kubex.k8s.v1_33.admissionregistration.v1beta1.validation import Validation
from kubex.k8s.v1_33.admissionregistration.v1beta1.variable import Variable
...
class ValidatingAdmissionPolicySpec(BaseK8sModel):
    ...
    audit_annotations: list[AuditAnnotation] | None = Field(
        default=None,
    ...
    validations: list[Validation] | None = Field(
        default=None,
        alias="validations",
