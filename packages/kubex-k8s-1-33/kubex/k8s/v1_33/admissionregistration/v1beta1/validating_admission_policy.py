...
from kubex.k8s.v1_33.admissionregistration.v1beta1.validating_admission_policy_spec import (
    ValidatingAdmissionPolicySpec,
)
from kubex.k8s.v1_33.admissionregistration.v1beta1.validating_admission_policy_status import (
