from kubex.k8s.v1_33.meta.v1.label_selector_requirement import LabelSelectorRequirement
from kubex_core.models.base import BaseK8sModel
from pydantic import Field


class LabelSelectorAttributes(BaseK8sModel):
    ...
    requirements: list[LabelSelectorRequirement] | None = Field(
        default=None,
        alias="requirements",
