...
from kubex.k8s.v1_33.resource.v1beta1.device_allocation_configuration import (
    DeviceAllocationConfiguration,
)
from kubex.k8s.v1_33.resource.v1beta1.device_request_allocation_result import (
