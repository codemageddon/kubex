...
from kubex.k8s.v1_33.resource.v1beta1.resource_claim_spec import ResourceClaimSpec
from kubex.k8s.v1_33.resource.v1beta1.resource_claim_status import ResourceClaimStatus
