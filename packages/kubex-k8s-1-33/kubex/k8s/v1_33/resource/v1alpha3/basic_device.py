...
from kubex.k8s.v1_33.resource.v1alpha3.device_attribute import DeviceAttribute
from kubex.k8s.v1_33.resource.v1alpha3.device_counter_consumption import (
