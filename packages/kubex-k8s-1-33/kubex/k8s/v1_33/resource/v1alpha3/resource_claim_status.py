...
from kubex.k8s.v1_33.resource.v1alpha3.allocated_device_status import (
    AllocatedDeviceStatus,
)
from kubex.k8s.v1_33.resource.v1alpha3.allocation_result import AllocationResult
from kubex.k8s.v1_33.resource.v1alpha3.resource_claim_consumer_reference import (
