from kubex.k8s.v1_33.resource.v1beta2.device_sub_request import DeviceSubRequest
from kubex.k8s.v1_33.resource.v1beta2.exact_device_request import ExactDeviceRequest
