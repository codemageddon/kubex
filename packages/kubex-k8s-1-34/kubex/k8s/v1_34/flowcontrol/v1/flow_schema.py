...
from kubex.k8s.v1_34.flowcontrol.v1.flow_schema_spec import FlowSchemaSpec
from kubex.k8s.v1_34.flowcontrol.v1.flow_schema_status import FlowSchemaStatus
