from kubex.k8s.v1_34.networking.v1.network_policy_peer import NetworkPolicyPeer
from kubex.k8s.v1_34.networking.v1.network_policy_port import NetworkPolicyPort
