...
from kubex.k8s.v1_34.certificates.v1alpha1.pod_certificate_request_spec import (
    PodCertificateRequestSpec,
)
from kubex.k8s.v1_34.certificates.v1alpha1.pod_certificate_request_status import (
