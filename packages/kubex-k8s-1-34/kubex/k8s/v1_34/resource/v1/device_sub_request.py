from kubex.k8s.v1_34.resource.v1.capacity_requirements import CapacityRequirements
from kubex.k8s.v1_34.resource.v1.device_selector import DeviceSelector
from kubex.k8s.v1_34.resource.v1.device_toleration import DeviceToleration
