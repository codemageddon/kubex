...
from kubex.k8s.v1_34.resource.v1beta2.counter_set import CounterSet
from kubex.k8s.v1_34.resource.v1beta2.device import Device
from kubex.k8s.v1_34.resource.v1beta2.resource_pool import ResourcePool
