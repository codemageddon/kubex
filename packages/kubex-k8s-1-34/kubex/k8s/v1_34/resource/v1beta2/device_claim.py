...
from kubex.k8s.v1_34.resource.v1beta2.device_claim_configuration import (
    DeviceClaimConfiguration,
)
from kubex.k8s.v1_34.resource.v1beta2.device_constraint import DeviceConstraint
from kubex.k8s.v1_34.resource.v1beta2.device_request import DeviceRequest
