...
from kubex.k8s.v1_34.autoscaling.v2.container_resource_metric_status import (
    ContainerResourceMetricStatus,
)
from kubex.k8s.v1_34.autoscaling.v2.external_metric_status import ExternalMetricStatus
from kubex.k8s.v1_34.autoscaling.v2.object_metric_status import ObjectMetricStatus
from kubex.k8s.v1_34.autoscaling.v2.pods_metric_status import PodsMetricStatus
from kubex.k8s.v1_34.autoscaling.v2.resource_metric_status import ResourceMetricStatus
