...
from kubex.k8s.v1_34.core.v1.persistent_volume_spec import PersistentVolumeSpec
from kubex.k8s.v1_34.core.v1.persistent_volume_status import PersistentVolumeStatus
