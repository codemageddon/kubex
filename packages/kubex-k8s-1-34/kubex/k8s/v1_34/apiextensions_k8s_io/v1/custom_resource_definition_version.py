from kubex.k8s.v1_34.apiextensions_k8s_io.v1.custom_resource_column_definition import (
    CustomResourceColumnDefinition,
)
from kubex.k8s.v1_34.apiextensions_k8s_io.v1.custom_resource_subresources import (
    CustomResourceSubresources,
)
from kubex.k8s.v1_34.apiextensions_k8s_io.v1.custom_resource_validation import (
    CustomResourceValidation,
)
from kubex.k8s.v1_34.apiextensions_k8s_io.v1.selectable_field import SelectableField
