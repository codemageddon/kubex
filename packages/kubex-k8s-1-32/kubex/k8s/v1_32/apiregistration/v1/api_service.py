...
from kubex.k8s.v1_32.apiregistration.v1.api_service_spec import APIServiceSpec
from kubex.k8s.v1_32.apiregistration.v1.api_service_status import APIServiceStatus
