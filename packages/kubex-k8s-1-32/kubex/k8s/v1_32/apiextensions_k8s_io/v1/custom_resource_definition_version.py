...
from kubex.k8s.v1_32.apiextensions_k8s_io.v1.custom_resource_subresources import (
    CustomResourceSubresources,
)
from kubex.k8s.v1_32.apiextensions_k8s_io.v1.custom_resource_validation import (
