from kubex.k8s.v1_32.core.v1.secret_reference import SecretReference
from kubex_core.models.base import BaseK8sModel
from pydantic import Field


class ISCSIPersistentVolumeSource(BaseK8sModel):
    ...
    iqn: str = Field(
        ..., alias="iqn", description="iqn is Target iSCSI Qualified Name."
    )
    ...
    lun: int = Field(..., alias="lun", description="lun is iSCSI Target Lun number.")
