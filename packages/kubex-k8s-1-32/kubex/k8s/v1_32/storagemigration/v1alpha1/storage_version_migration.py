...
from kubex.k8s.v1_32.storagemigration.v1alpha1.storage_version_migration_spec import (
    StorageVersionMigrationSpec,
)
from kubex.k8s.v1_32.storagemigration.v1alpha1.storage_version_migration_status import (
