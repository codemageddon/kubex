from kubex.k8s.v1_32.meta.v1.field_selector_requirement import FieldSelectorRequirement
from kubex_core.models.base import BaseK8sModel
from pydantic import Field


class FieldSelectorAttributes(BaseK8sModel):
    ...
    requirements: list[FieldSelectorRequirement] | None = Field(
        default=None,
        alias="requirements",
