...
from kubex.k8s.v1_32.resource.v1alpha3.device_claim_configuration import (
    DeviceClaimConfiguration,
)
from kubex.k8s.v1_32.resource.v1alpha3.device_constraint import DeviceConstraint
from kubex.k8s.v1_32.resource.v1alpha3.device_request import DeviceRequest
