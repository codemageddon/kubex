...
from kubex.k8s.v1_32.flowcontrol.v1.priority_level_configuration_spec import (
    PriorityLevelConfigurationSpec,
)
from kubex.k8s.v1_32.flowcontrol.v1.priority_level_configuration_status import (
