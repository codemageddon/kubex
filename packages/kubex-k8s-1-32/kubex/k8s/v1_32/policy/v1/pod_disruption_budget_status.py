...
from kubex.k8s.v1_32.meta.v1.condition import Condition
from kubex_core.models.base import BaseK8sModel
from pydantic import Field


class PodDisruptionBudgetStatus(BaseK8sModel):
    ...
    disrupted_pods: dict[str, datetime.datetime] | None = Field(
        default=None,
        alias="disruptedPods",
