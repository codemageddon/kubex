...
from kubex.k8s.v1_32.networking.v1.ingress_backend import IngressBackend
from kubex.k8s.v1_32.networking.v1.ingress_rule import IngressRule
from kubex.k8s.v1_32.networking.v1.ingress_tls import IngressTLS
...
class IngressSpec(BaseK8sModel):
    ...
    default_backend: IngressBackend | None = Field(
        default=None,
    ...
    rules: list[IngressRule] | None = Field(
        default=None,
        alias="rules",
    ...
    tls: list[IngressTLS] | None = Field(
        default=None,
        alias="tls",
