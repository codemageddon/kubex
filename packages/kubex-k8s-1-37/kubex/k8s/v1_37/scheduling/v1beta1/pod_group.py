...
from kubex.k8s.v1_37.scheduling.v1beta1.pod_group_spec import PodGroupSpec
from kubex.k8s.v1_37.scheduling.v1beta1.pod_group_status import PodGroupStatus
...
class PodGroup(NamespaceScopedEntity, HasStatusSubresource):
    ...
    api_version: Literal["scheduling.k8s.io/v1beta1"] = Field(
