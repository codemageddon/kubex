...
from kubex.k8s.v1_37.scheduling.v1beta1.all_composite_disruption_mode import (
    AllCompositeDisruptionMode,
)
from kubex.k8s.v1_37.scheduling.v1beta1.single_composite_disruption_mode import (
