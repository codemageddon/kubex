...
from kubex.k8s.v1_37.scheduling.v1alpha3.all_composite_disruption_mode import (
    AllCompositeDisruptionMode,
)
from kubex.k8s.v1_37.scheduling.v1alpha3.single_composite_disruption_mode import (
