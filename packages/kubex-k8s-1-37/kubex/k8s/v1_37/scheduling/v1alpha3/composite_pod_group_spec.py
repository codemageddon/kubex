...
from kubex.k8s.v1_37.scheduling.v1alpha3.composite_disruption_mode import (
    CompositeDisruptionMode,
)
from kubex.k8s.v1_37.scheduling.v1alpha3.composite_pod_group_scheduling_constraints import (
    CompositePodGroupSchedulingConstraints,
)
from kubex.k8s.v1_37.scheduling.v1alpha3.composite_pod_group_scheduling_policy import (
    CompositePodGroupSchedulingPolicy,
)
from kubex.k8s.v1_37.scheduling.v1alpha3.workload_reference import WorkloadReference
