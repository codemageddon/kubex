...
from kubex.k8s.v1_37.scheduling.v1alpha3.composite_basic_scheduling_policy import (
    CompositeBasicSchedulingPolicy,
)
from kubex.k8s.v1_37.scheduling.v1alpha3.composite_gang_scheduling_policy import (
