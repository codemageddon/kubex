...
from kubex.k8s.v1_37.scheduling.v1alpha3.workload_pod_group_all_disruption_mode import (
    WorkloadPodGroupAllDisruptionMode,
)
from kubex.k8s.v1_37.scheduling.v1alpha3.workload_pod_group_single_disruption_mode import (
