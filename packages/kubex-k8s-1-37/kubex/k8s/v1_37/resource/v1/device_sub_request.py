...
from kubex.k8s.v1_37.resource.v1.capacity_requirements import CapacityRequirements
from kubex.k8s.v1_37.resource.v1.device_derived_attribute import DeviceDerivedAttribute
from kubex.k8s.v1_37.resource.v1.device_selector import DeviceSelector
