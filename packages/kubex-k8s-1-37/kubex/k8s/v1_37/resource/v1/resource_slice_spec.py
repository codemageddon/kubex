...
from kubex.k8s.v1_37.resource.v1.counter_set import CounterSet
from kubex.k8s.v1_37.resource.v1.device import Device
from kubex.k8s.v1_37.resource.v1.resource_pool import ResourcePool
