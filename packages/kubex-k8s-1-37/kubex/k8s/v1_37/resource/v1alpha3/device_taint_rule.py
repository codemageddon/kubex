...
from kubex.k8s.v1_37.resource.v1alpha3.device_taint_rule_spec import DeviceTaintRuleSpec
from kubex.k8s.v1_37.resource.v1alpha3.device_taint_rule_status import (
