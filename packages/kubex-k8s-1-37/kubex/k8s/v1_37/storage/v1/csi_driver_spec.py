...
from kubex.k8s.v1_37.storage.v1.token_request import TokenRequest
from kubex_core.models.base import BaseK8sModel


class CSIDriverSpec(BaseK8sModel):
    ...
    service_account_token_in_secrets: bool | None = Field(
        default=None,
        alias="serviceAccountTokenInSecrets",
    ...
    token_requests: list[TokenRequest] | None = Field(
        default=None,
        alias="tokenRequests",
