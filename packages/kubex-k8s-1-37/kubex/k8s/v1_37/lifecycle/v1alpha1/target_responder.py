...
class TargetResponder(BaseK8sModel):
    ...
    name: str = Field(
        ...,
        alias="name",
        description='name allows you to identify the responder reacting to the Eviction. It must be a valid domain-prefixed key (such as "acme.io/foo"). This field must be unique for each responder. This field is required.',
    )
    priority: int = Field(
        ...,
        alias="priority",
