...
from kubex.k8s.v1_37.certificates.v1beta1.pod_certificate_request_spec import (
    PodCertificateRequestSpec,
)
from kubex.k8s.v1_37.certificates.v1beta1.pod_certificate_request_status import (
