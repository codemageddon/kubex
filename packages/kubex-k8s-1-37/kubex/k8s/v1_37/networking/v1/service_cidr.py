...
from kubex.k8s.v1_37.networking.v1.service_cidr_spec import ServiceCIDRSpec
from kubex.k8s.v1_37.networking.v1.service_cidr_status import ServiceCIDRStatus
