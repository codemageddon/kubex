...
from kubex.k8s.v1_36.networking.v1beta1.service_cidr_spec import ServiceCIDRSpec
from kubex.k8s.v1_36.networking.v1beta1.service_cidr_status import ServiceCIDRStatus
