...
from kubex.k8s.v1_36.apiextensions_k8s_io.v1.custom_resource_definition_spec import (
    CustomResourceDefinitionSpec,
)
from kubex.k8s.v1_36.apiextensions_k8s_io.v1.custom_resource_definition_status import (
