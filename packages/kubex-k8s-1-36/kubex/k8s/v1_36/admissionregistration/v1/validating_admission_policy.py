...
from kubex.k8s.v1_36.admissionregistration.v1.validating_admission_policy_spec import (
    ValidatingAdmissionPolicySpec,
)
from kubex.k8s.v1_36.admissionregistration.v1.validating_admission_policy_status import (
