from kubex.k8s.v1_36.apps.v1.stateful_set_ordinals import StatefulSetOrdinals
from kubex.k8s.v1_36.apps.v1.stateful_set_persistent_volume_claim_retention_policy import (
    StatefulSetPersistentVolumeClaimRetentionPolicy,
)
from kubex.k8s.v1_36.apps.v1.stateful_set_update_strategy import (
    StatefulSetUpdateStrategy,
)
from kubex.k8s.v1_36.core.v1.persistent_volume_claim import PersistentVolumeClaim
from kubex.k8s.v1_36.core.v1.pod_template_spec import PodTemplateSpec
