...
from kubex.k8s.v1_36.resource.v1beta1.device_counter_consumption import (
    DeviceCounterConsumption,
)
from kubex.k8s.v1_36.resource.v1beta1.device_taint import DeviceTaint
from kubex.k8s.v1_36.resource.v1beta1.node_allocatable_resource_mapping import (
