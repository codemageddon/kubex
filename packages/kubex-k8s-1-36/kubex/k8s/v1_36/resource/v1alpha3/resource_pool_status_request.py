...
from kubex.k8s.v1_36.resource.v1alpha3.resource_pool_status_request_spec import (
    ResourcePoolStatusRequestSpec,
)
from kubex.k8s.v1_36.resource.v1alpha3.resource_pool_status_request_status import (
