from kubex.k8s.v1_36.resource.v1.capacity_requirements import CapacityRequirements
from kubex.k8s.v1_36.resource.v1.device_selector import DeviceSelector
