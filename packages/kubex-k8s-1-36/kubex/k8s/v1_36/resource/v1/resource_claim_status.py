from kubex.k8s.v1_36.resource.v1.allocated_device_status import AllocatedDeviceStatus
from kubex.k8s.v1_36.resource.v1.allocation_result import AllocationResult
from kubex.k8s.v1_36.resource.v1.resource_claim_consumer_reference import (
