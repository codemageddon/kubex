...
from kubex.k8s.v1_36.batch.v1.pod_failure_policy_on_exit_codes_requirement import (
    PodFailurePolicyOnExitCodesRequirement,
)
from kubex.k8s.v1_36.batch.v1.pod_failure_policy_on_pod_conditions_pattern import (
