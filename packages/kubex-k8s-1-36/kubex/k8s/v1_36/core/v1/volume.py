from kubex.k8s.v1_36.core.v1.aws_elastic_block_store_volume_source import (
    AWSElasticBlockStoreVolumeSource,
)
from kubex.k8s.v1_36.core.v1.azure_disk_volume_source import AzureDiskVolumeSource
from kubex.k8s.v1_36.core.v1.azure_file_volume_source import AzureFileVolumeSource
from kubex.k8s.v1_36.core.v1.ceph_fs_volume_source import CephFSVolumeSource
from kubex.k8s.v1_36.core.v1.cinder_volume_source import CinderVolumeSource
from kubex.k8s.v1_36.core.v1.config_map_volume_source import ConfigMapVolumeSource
from kubex.k8s.v1_36.core.v1.csi_volume_source import CSIVolumeSource
from kubex.k8s.v1_36.core.v1.downward_api_volume_source import DownwardAPIVolumeSource
from kubex.k8s.v1_36.core.v1.empty_dir_volume_source import EmptyDirVolumeSource
from kubex.k8s.v1_36.core.v1.ephemeral_volume_source import EphemeralVolumeSource
from kubex.k8s.v1_36.core.v1.fc_volume_source import FCVolumeSource
from kubex.k8s.v1_36.core.v1.flex_volume_source import FlexVolumeSource
from kubex.k8s.v1_36.core.v1.flocker_volume_source import FlockerVolumeSource
from kubex.k8s.v1_36.core.v1.gce_persistent_disk_volume_source import (
    GCEPersistentDiskVolumeSource,
)
from kubex.k8s.v1_36.core.v1.git_repo_volume_source import GitRepoVolumeSource
from kubex.k8s.v1_36.core.v1.glusterfs_volume_source import GlusterfsVolumeSource
from kubex.k8s.v1_36.core.v1.host_path_volume_source import HostPathVolumeSource
from kubex.k8s.v1_36.core.v1.image_volume_source import ImageVolumeSource
from kubex.k8s.v1_36.core.v1.iscsi_volume_source import ISCSIVolumeSource
from kubex.k8s.v1_36.core.v1.nfs_volume_source import NFSVolumeSource
from kubex.k8s.v1_36.core.v1.persistent_volume_claim_volume_source import (
    PersistentVolumeClaimVolumeSource,
)
from kubex.k8s.v1_36.core.v1.photon_persistent_disk_volume_source import (
    PhotonPersistentDiskVolumeSource,
)
from kubex.k8s.v1_36.core.v1.portworx_volume_source import PortworxVolumeSource
from kubex.k8s.v1_36.core.v1.projected_volume_source import ProjectedVolumeSource
from kubex.k8s.v1_36.core.v1.quobyte_volume_source import QuobyteVolumeSource
from kubex.k8s.v1_36.core.v1.rbd_volume_source import RBDVolumeSource
from kubex.k8s.v1_36.core.v1.scale_io_volume_source import ScaleIOVolumeSource
from kubex.k8s.v1_36.core.v1.secret_volume_source import SecretVolumeSource
from kubex.k8s.v1_36.core.v1.storage_os_volume_source import StorageOSVolumeSource
from kubex.k8s.v1_36.core.v1.vsphere_virtual_disk_volume_source import (
