...
from kubex.k8s.v1_36.core.v1.limit_range import LimitRange
from kubex_core.models.list_entity import ListEntity
from kubex_core.models.metadata import ListMetadata


class LimitRangeList(ListEntity[LimitRange]):
    ...
    kind: Literal["LimitRangeList"] = Field(
...
LimitRange.__RESOURCE_CONFIG__._list_model = LimitRangeList
