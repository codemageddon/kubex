...
from kubex.k8s.v1_36.authentication.v1.token_review_spec import TokenReviewSpec
from kubex.k8s.v1_36.authentication.v1.token_review_status import TokenReviewStatus
