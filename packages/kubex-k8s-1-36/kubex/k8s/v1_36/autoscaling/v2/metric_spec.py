...
from kubex.k8s.v1_36.autoscaling.v2.external_metric_source import ExternalMetricSource
from kubex.k8s.v1_36.autoscaling.v2.object_metric_source import ObjectMetricSource
