...
from kubex.k8s.v1_36.autoscaling.v2.external_metric_status import ExternalMetricStatus
from kubex.k8s.v1_36.autoscaling.v2.object_metric_status import ObjectMetricStatus
