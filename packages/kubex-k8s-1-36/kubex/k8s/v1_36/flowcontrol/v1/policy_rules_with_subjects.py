from kubex.k8s.v1_36.flowcontrol.v1.non_resource_policy_rule import (
    NonResourcePolicyRule,
)
from kubex.k8s.v1_36.flowcontrol.v1.resource_policy_rule import ResourcePolicyRule
from kubex.k8s.v1_36.flowcontrol.v1.subject import Subject
